...
public class SonClass4edgeDataProv extends TestBaseCross {
    ...
    public static Object[][] aranacaklarListesi() {
       ...
       String[][] aranacaklarListesii= {{"Konyaspor" },{"Giresunspor"},{"İstanbulspor"},{"Kasımpaşa"}};

        return aranacaklarListesii;
    }
    ...
    public void test01(String takım){
        ...
        String hangiTakım=takım;  //sadece şehir ismi girersen hata verir
