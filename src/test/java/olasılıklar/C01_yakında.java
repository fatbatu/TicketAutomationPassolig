...
public class C01_yakında extends TestBaseCross {
    ...
    public void test01(){
        ...
        String hangiTakım="YOK BÖYLE Bİ TAKIM";  //sadece şehir ismi girersen hata verir
    ...
    public static void baglantıyaGitveSatınAl(String hangiTakım, String gidilecekLink){
        ...
        while (flag=true){
            ...
            try {
                ...
                if (!satınAl.isEnabled()){
                    throw new NullPointerException(); }
                jse.executeScript("arguments[0].scrollIntoView();",satınAl);
                jse.executeScript("arguments[0].click();",satınAl);
                flag=false; // gereksiz sanırsam
                break;

            } catch (Exception e) {
                System.out.println("Satın Al tuşu çıkmadı");
                driver.navigate().refresh(); // uzun sürebilir
